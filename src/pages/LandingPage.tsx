...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      {/* Hero Section */}
      <section className="py-16 md:py-24 border-b-[3px] border-foreground bg-[#fffdf5]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block mb-6 md:mb-8">
              <span className="brutal-tag text-base md:text-lg px-4 py-2 bg-secondary">
                <Star className="w-5 h-5 inline mr-2 fill-current" />
                KHUSUS UMKM INDONESIA
              </span>
            </div>
            
            <h1 className="font-display text-5xl md:text-7xl mb-6 md:mb-8 leading-[1.1] uppercase">
              Bikin Foto Produk Bagus<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-600 stroke-foreground" style={{ WebkitTextStroke: '2px black' }}>Cuma Pakai HP</span>
            </h1>
            
            <p className="text-xl md:text-2xl font-medium mb-10 max-w-2xl mx-auto text-slate-700 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/dashboard" className="brutal-btn-primary text-xl px-8 py-4 w-full sm:w-auto shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all">
                <Zap className="w-6 h-6 mr-2" />
                Coba Gratis Sekarang
              </Link>
              <p className="text-sm font-bold mt-2 sm:mt-0 sm:ml-4 flex items-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {steps.map((step, index) => (
              <div key={index} className="relative p-8 border-[3px] border-foreground bg-secondary rounded-lg shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                <div className="absolute -top-6 -left-6 w-12 h-12 bg-foreground text-white rounded-full flex items-center justify-center text-2xl font-bold border-[3px] border-white">
                  {step.number}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white p-8 border-[3px] border-foreground shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[-4px] hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] transition-all duration-300"
              >
                <div className="bg-accent w-16 h-16 flex items-center justify-center border-[3px] border-foreground mb-6 rounded-full">
      ...
      {/* CTA */}
      <section className="py-24 bg-accent border-y-[3px] border-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link to="/dashboard" className="inline-flex items-center justify-center bg-white text-foreground text-xl md:text-2xl font-bold py-4 px-10 border-[3px] border-foreground shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] transition-all">
